      ...
      <div>
        ...
        <div className="mt-1  grid grid-cols-1 md:grid-cols-3  gap-5 px-5 md:px-10 md:mt-30 ">
          ...
          <div className=" h-auto md:col-span-1  p-10">
            <div className="h-[200px] w-full bg-yellow-400 rounded-lg flex flex-col  p-8 ">
              <h3 className="text-lg md:text-2xl font-bold py-2 mb-2 md:mb-5">Search</h3>
              <div className="flex  bg-white p-3 rounded-lg focus:ring-2 focus:ring-green-600"> <input type="text" placeholder="search more info" className="outline-none" />  <span className="text-gray-400"><Search  /></span> </div>
            </div>
